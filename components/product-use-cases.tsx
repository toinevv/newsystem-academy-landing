...
export default async function ProductUseCases() {
  const useCases = await getUseCasesByType("product")
  ...
  return (
    <section id="use-cases" className="section bg-[#051a25]">
      <div className="container-custom">
        <h2 className="section-title text-center">Product Use Cases</h2>
        <p className="text-center text-lg mb-12 max-w-3xl mx-auto">
          See how our AI platform transforms warehouse operations with real-world examples and measurable results.
        </p>
